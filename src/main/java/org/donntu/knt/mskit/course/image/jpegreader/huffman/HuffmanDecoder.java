package org.donntu.knt.mskit.course.image.jpegreader.huffman;


import org.donntu.knt.mskit.course.image.jpegreader.MCUBlockHolder;
import org.donntu.knt.mskit.course.image.jpegreader.segments.SOFComponent;
import org.donntu.knt.mskit.course.image.jpegreader.segments.SOSComponent;
import org.donntu.knt.mskit.course.image.jpegreader.utils.ArraysUtil;
import org.donntu.knt.mskit.course.image.jpegreader.utils.BitInputStream;
...
public class HuffmanDecoder {
    ...
    private void decodeAC(HuffmanTree acTable) throws IOException{
        for (int k = 1; k < ArraysUtil.SIZE * ArraysUtil.SIZE; k++) {
            ...
            int zerosNumber = BitUtil.first4Bits(code);
            int bitCount = BitUtil.last4Bits(code);
